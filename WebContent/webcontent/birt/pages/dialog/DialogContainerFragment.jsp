...
<div id="<%=fragment.getClientId()%>" class="dialogBorder"
	style="display: none; position: absolute; z-index: 220">
	<iframe id="<%=fragment.getClientId()%>iframe"
		name="<%=fragment.getClientId()%>iframe"
	...
	<div id="<%=fragment.getClientId()%>dialogTitleBar"
		class="dialogTitleBar dTitleBar">
		<div class="dTitleTextContainer">
			<table style="width: 100%; height: 100%;">
				<tr>
					<td class="dialogTitleText dTitleText"><%=fragment.getTitle()%>
					</td>
				</tr>
			</table>
		</div>
			...
			<table style="width: 100%; height: 100%; border-collapse: collapse">
				...
				<tr>
					<td><label class="birtviewer_hidden_label"
						for="<%=fragment.getClientId()%>dialogCloseBtn"> <%=BirtResources.getMessage("birt.viewer.dialog.close")%>
					</label>
						<div id="<%=fragment.getClientId()%>dialogCloseBtn"
							class="dialogCloseBtn dCloseBtn" /></td>
				</tr>
			</table>
		</div>
	</div>
	<div style="background-color: white; text-align: center;">
		<br> <br>
		<h1>
			<a href="/BPS_BIRT_Reports/frontpage" style="color: black">BPS Reports</a>
		</h1>
		<br> <br>
	</div>
	...
	<div class="dialogBackground" style="overflow: auto;">
		<div class="dBackground">
			<div class="dialogContentContainer"
				id="<%=fragment.getClientId()%>dialogContentContainer">
				<%
					if (fragment != null) {
			...
			<div class="dialogBtnBarContainer">
				...
				<div class="dialogBtnBar">
					<div id="<%=fragment.getClientId()%>dialogCustomButtonContainer"
						class="dialogBtnBarButtonContainer">
						<div id="<%=fragment.getClientId()%>okButton">
							<div id="<%=fragment.getClientId()%>okButtonLeft"
								class="dialogBtnBarButtonLeftBackgroundEnabled"></div>
							<div id="<%=fragment.getClientId()%>okButtonRight"
								class="dialogBtnBarButtonRightBackgroundEnabled"></div>
							<input type="button"
								value="<%=BirtResources.getHtmlMessage("birt.viewer.dialog.ok")%>"
						...
						<div id="<%=fragment.getClientId()%>cancelButton">
							...
							<input type="button"
								value="<%=BirtResources.getHtmlMessage("birt.viewer.dialog.cancel")%>"
